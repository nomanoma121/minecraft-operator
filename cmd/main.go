...
import (
	...
	"github.com/nomanoma121/minecraft-operator/internal/controller"
...
func main() {
	...
	mgr, err := ctrl.NewManager(ctrl.GetConfigOrDie(), ctrl.Options{
		...
		LeaderElectionID:       "0acf637b.nomanoma-dev.com",
	...
	if err := (&controller.MinecraftServerReconciler{
		...
		setupLog.Error(err, "Failed to create controller", "controller", "MinecraftServer")
		os.Exit(1)
	}
	if err := (&controller.MinecraftProxyReconciler{
		...
		setupLog.Error(err, "Failed to create controller", "controller", "MinecraftProxy")
		os.Exit(1)
	}
	if err := (&controller.MinecraftNetworkReconciler{
		Client: mgr.GetClient(),
		Scheme: mgr.GetScheme(),
	}).SetupWithManager(mgr); err != nil {
		setupLog.Error(err, "Failed to create controller", "controller", "MinecraftNetwork")
		os.Exit(1)
	}
